...
function cardClick(e) {
  ...
  // set local storage here conditional to check if current score is lower than best score
  // if current is lower then set best score = currentscore 
  // else best score = best score
